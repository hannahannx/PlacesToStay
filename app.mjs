...
app.post('/placestostay/accommodation/:accID/date/:thedate/usernam/people/:npeople/', (req,res)=>{
    try{
        ...
        const bookingResults = createBooking.run(req.params.accID,req.params.thedate,req.params.thedate)
